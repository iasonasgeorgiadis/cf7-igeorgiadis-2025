...
const seedDatabase = async () => {
  ...
  try {
    ...
    const adminPassword = await bcrypt.hash('AdminPass123!', config.bcrypt.saltRounds);
    ...
    const adminResult = await client.query(`
      ...
      VALUES ($1, $2, $3, $4, $5)
      RETURNING id
    `, ['admin@lms.com', adminPassword, 'Admin', 'User', 'admin']);
    ...
    console.log('\nTest users created:');
    console.log('- Admin: admin@lms.com / AdminPass123!');
